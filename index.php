						...
						<section class="notices__container">
							...
							<div class="section-footer buttons-panel">
								...
								<div class="marquee-controls">
									<button class="btn btn-outline-secondary"><span class="fas fa-chevron-down"></span></button>
									<button class="btn btn-outline-secondary"><span class="fas fa-chevron-up"></span></button>
								</div>
							</div>
						</section>
					</div>
